        ...
        <div className="container">
          <div className="md:mx-28 grid grid-cols-2 sm:grid-cols-4">
            <div className="flex flex-col justify-center items-center">
              <h2 className="text-5xl font-bold">{counter?.happyClient}</h2>
              <p className="text-sm">Happy Clients</p>
            </div>
            <div className="flex flex-col justify-center items-center">
              <h2 className="text-5xl font-bold">{counter?.sellEquepment}</h2>
              <p className="text-sm">Sell Equepment</p>
            </div>
            <div className="flex flex-col justify-center items-center">
              <h2 className="text-5xl font-bold">{counter?.teamMember}</h2>
              <p className="text-sm">Team Members</p>
            </div>
            <div className="flex flex-col justify-center items-center">
              <h2 className="text-5xl font-bold">{counter?.award}</h2>
